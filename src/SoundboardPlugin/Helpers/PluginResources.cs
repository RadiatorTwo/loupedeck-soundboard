namespace Loupedeck.SoundboardPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SoundboardPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SoundboardPlugin.Resources.Resource.txt`.
